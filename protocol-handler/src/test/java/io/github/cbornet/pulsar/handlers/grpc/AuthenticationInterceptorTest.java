...
import io.github.cbornet.pulsar.handlers.grpc.test.AuthGrpc;
...
import static io.github.cbornet.pulsar.handlers.grpc.Constants.AUTHCHALLENGE_METADATA_KEY;
import static io.github.cbornet.pulsar.handlers.grpc.Constants.AUTHRESPONSE_METADATA_KEY;
...
import static io.github.cbornet.pulsar.handlers.grpc.Constants.AUTH_ROLE_TOKEN_METADATA_KEY;
...
public class AuthenticationInterceptorTest {
    ...
    public void testAuthenticationSasl() throws Exception {
        ...
        io.github.cbornet.pulsar.handlers.grpc.api.AuthData challenge = null;
        try {
            authStub.getPrincipal(Empty.getDefaultInstance());
